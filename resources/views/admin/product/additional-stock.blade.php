...
<script src="/js/admin/{{ $controller }}/additional-list-datatable.js" type="text/javascript"></script>
@endsection
        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                ...
                @if (auth()->user()->can($controller.'-create'))
                    <a href="{{ route($controller.'.additionalStock.create', ['product'=>$product->id]) }}" class="btn btn-brand btn-elevate btn-icon-sm">
