...
<div class="kt-portlet kt-portlet--mobile">
    ...
    {!! Form::open(['route' => [$controller.'.update', $user->id], 'method'=>'PUT', 'class' => 'kt-form', 'id'=>'kt_form']) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select class="form-control" multiple="multiple" name="role[]" id="role" required="">
                                    ...
                                    <option value="{{ $k }}" {{ in_array($k, $utils['options']['roleSelecteds']) ? 'selected' : '' }}>{{ $v }}</option>
                                    @endforeach
                                </select>
