                    ...
                    <div class="kt-section__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                {!! Form::text('color_hex', old('color_hex'), ['required', 'maxlength'=>6, 'class'=>'text-lowercase form-control'.( $errors->has('code') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('title', old('title'), ['required', 'maxlength'=>80, 'class'=>'form-control'.( $errors->has('title') ? ' is-invalid' : '' ) ]); !!}
