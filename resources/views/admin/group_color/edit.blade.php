...
<div class="kt-portlet kt-portlet--mobile">
    ...
    {!! Form::open(['route' => [$controller.'.update', $group_color->id], 'method'=>'PUT', 'class' => 'kt-form', 'id'=>'kt_form']) !!}
                ...
                <div class="kt-section kt-section--first">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                {!! Form::text('color_hex', $group_color->color_hex, ['required', 'maxlength'=>6, 'class'=>'text-lowercase form-control'.( $errors->has('code') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('title', $group_color->title, ['required', 'maxlength'=>80, 'class'=>'form-control'.( $errors->has('title') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('slug', $group_color->slug, ['required', 'class'=>'form-control'.( $errors->has('slug') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 col-xl-3">
                                {!! Form::number('sort_order', $group_color->sort_order, ['class'=>'form-control'.( $errors->has('sort_order') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="kt-radio-inline">
                                    @php
                                    $optionSelected = $group_color->status;
                                    @endphp
