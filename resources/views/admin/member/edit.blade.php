...
<div class="kt-portlet kt-portlet--mobile">
    ...
    {!! Form::open(['route' => [$controller.'.update', $member->id], 'method'=>'PUT', 'class' => 'kt-form', 'id'=>'kt_form']) !!}
                    ...
                    <div class="kt-section__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('name', $member->name, ['required', 'class'=>'form-control'.( $errors->has('name') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                {!! Form::email('email', $member->email, ['required', 'class'=>'form-control'.( $errors->has('email') ? ' is-invalid' : '' ) ]); !!}
                                @if ($errors->has('email')) <span class="form-text kt-font-danger"> {{ $errors->first('email') }} </span>@endif
                            </div>
                        </div>

                        <div class="form-group row">
                            {!! Form::label('wa_number', __('main.no_wa'), ['class'=>'col-xl-3 col-lg-3 col-form-label']); !!}
                            <div class="col-md-7">
                                {!! Form::text('wa_number', $member->wa_number, ['required', 'class'=>'form-control'.( $errors->has('wa_number') ? ' is-invalid' : '' ) ]); !!}
                                @if ($errors->has('wa_number')) <span class="form-text kt-font-danger"> {{ $errors->first('wa_number') }} </span>@endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('username', $member->username, ['required', 'class'=>'form-control'.( $errors->has('username') ? ' is-invalid' : '' ) ]); !!}
