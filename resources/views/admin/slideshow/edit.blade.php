...
<div class="kt-portlet kt-portlet--mobile">
    ...
    {!! Form::open(['route' => [$controller.'.update', $slideshow->id], 'method'=>'PUT', 'class' => 'kt-form', 'id'=>'kt_form', 'enctype'=>"multipart/form-data"]) !!}
                    ...
                    <div class="kt-section__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('title', $slideshow->title, ['required', 'class'=>'form-control'.( $errors->has('title') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('title_id', $slideshow->title_id, ['required', 'class'=>'form-control'.( $errors->has('title_id') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::url('url', $slideshow->url, ['class'=>'form-control'.( $errors->has('url') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                            {!! Form::select('target', $utils['options']['target'], $slideshow->target, ['class'=>'form-control custom-select']); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 col-xl-3">
                                {!! Form::number('sort_order', $slideshow->sort_order, ['required', 'class'=>'form-control'.( $errors->has('sort_order') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div style="margin-top: 20px;">
                                    <img src="{{ route(config('imagecache.route'), ['template' => 'resize-medium', 'filename' => \App\Slideshow::getImage($slideshow) ]) }}" alt="" class="img-circle">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="kt-radio-inline">
                                    @php
                                    $optionSelected = $slideshow->status;
                                    @endphp
                        ...
                        <div class="d-none">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    {!! Form::text('meta['.$k.']', isset($utils['options']['meta_selected'][$k]) ? $utils['options']['meta_selected'][$k] : '', ['class'=>'form-control'.( $errors->has('meta.'.$k) ? ' is-invalid' : '' ) ]); !!}
