...
<div class="kt-portlet kt-portlet--mobile">
    ...
    {!! Form::open(['route' => [$controller.'.update', $dropdown->id], 'method'=>'PUT', 'class' => 'kt-form', 'id'=>'kt_form']) !!}
                ...
                <div class="kt-section kt-section--first">
                    <div class="kt-section__body">
                        <div class="form-group row">
                            {!! Form::label('code', 'Kode', ['class'=>'col-xl-3 col-lg-3 col-form-label']); !!}
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('code', $dropdown->code, ['required', 'class'=>'text-lowercase form-control'.( $errors->has('code') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('title', $dropdown->title, ['required', 'class'=>'form-control'.( $errors->has('title') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('description', $dropdown->description, ['class'=>'form-control'.( $errors->has('description') ? ' is-invalid' : '' ) ]); !!}
