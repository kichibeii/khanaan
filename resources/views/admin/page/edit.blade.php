...
<div class="kt-portlet kt-portlet--mobile">
    ...
    {!! Form::open(['route' => [$controller.'.update', $page->id], 'method'=>'PUT', 'class' => 'kt-form', 'id'=>'kt_form']) !!}
                    ...
                    <div class="kt-section__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('title', $page->title, ['required', 'class'=>'form-control'.( $errors->has('title') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('title_id', $page->title_id, ['required', 'class'=>'form-control'.( $errors->has('title_id') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('slug', $page->slug, ['required', 'class'=>'form-control'.( $errors->has('slug') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::textarea('description', $page->description, ['class'=>'form-control'.( $errors->has('description') ? ' is-invalid' : '' ), 'autocomplete'=>'off' ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::textarea('description_id', $page->description_id, ['class'=>'form-control'.( $errors->has('description_id') ? ' is-invalid' : '' ), 'autocomplete'=>'off' ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::number('sort_order', $page->sort_order, ['required', 'class'=>'form-control'.( $errors->has('sort_order') ? ' is-invalid' : '' ) ]); !!}
