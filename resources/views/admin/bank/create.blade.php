                ...
                <div class="kt-section kt-section--first">
                    <div class="kt-section__body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('account_number', old('account_number'), ['required', 'maxlength'=>20, 'class'=>'form-control'.( $errors->has('account_number') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('owner_name', old('owner_name'), ['required', 'maxlength'=>100, 'class'=>'form-control'.( $errors->has('owner_name') ? ' is-invalid' : '' ) ]); !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('branch', old('branch'), ['required', 'maxlength'=>70, 'class'=>'form-control'.( $errors->has('branch') ? ' is-invalid' : '' ) ]); !!}
