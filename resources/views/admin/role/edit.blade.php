...
<div class="kt-portlet kt-portlet--mobile">
    ...
    {!! Form::open(['route' => [$controller.'.update', $role->id], 'method'=>'PUT', 'class' => 'kt-form', 'id'=>'kt_form']) !!}
                    ...
                    <div class="kt-section__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                {!! Form::text('display_name', $role->display_name, ['required', 'class'=>'form-control'.( $errors->has('display_name') ? ' is-invalid' : '' ) ]); !!}
