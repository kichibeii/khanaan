	...
	var initTable1 = function() {
		...
		table.DataTable({
			...
			columns: [
                ...
                { data: 'totalItem', name: 'totalItem', sortable: false, className: 'col-center'},
			...
			columnDefs: [
                
                {
                    ...
                    render: function(data, type, full, meta) {
                        var itemUrl = full['itemUrl'];
                        var eHtml = ``;
                        
                        eHtml += `
                            <a class="btn btn-bold btn-sm btn-font-sm btn-label-success" href="${itemUrl}" title="Opsi">
                                ${full['totalItem']}
                            </a>`;
